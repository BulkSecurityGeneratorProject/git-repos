...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('gitReposApp.jobHistory.home.title');
  });
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('gitReposApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('gitReposApp.jobHistory.delete.question');
