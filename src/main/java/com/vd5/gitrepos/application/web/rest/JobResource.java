...
import com.vd5.gitrepos.application.domain.Job;
import com.vd5.gitrepos.application.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.vd5.gitrepos.application.domain.Job}.
 */
@RestController
@RequestMapping("/api")
