package com.vd5.gitrepos.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.vd5.gitrepos.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.vd5.gitrepos.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
