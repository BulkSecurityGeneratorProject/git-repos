...
describe('Region e2e test', () => {
  ...
  it('should load Regions', async () => {
    ...
    expect(await regionComponentsPage.getTitle()).to.eq('gitReposApp.region.home.title');
  });
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle()).to.eq('gitReposApp.region.home.createOrEditLabel');
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle()).to.eq('gitReposApp.region.delete.question');
