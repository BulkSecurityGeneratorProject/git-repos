...
import com.vd5.gitrepos.application.domain.Task;
import com.vd5.gitrepos.application.service.TaskService;
...
/**
 * REST controller for managing {@link com.vd5.gitrepos.application.domain.Task}.
 */
@RestController
@RequestMapping("/api")
