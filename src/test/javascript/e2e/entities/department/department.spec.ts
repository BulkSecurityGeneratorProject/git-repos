...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('gitReposApp.department.home.title');
  });
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('gitReposApp.department.home.createOrEditLabel');
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('gitReposApp.department.delete.question');
